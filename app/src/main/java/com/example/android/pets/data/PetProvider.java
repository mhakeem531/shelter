...
public class PetProvider extends ContentProvider {
    ...
    private Uri insertPet(Uri uri, ContentValues values) throws IllegalArgumentException {
        ...
        String gender = values.getAsString(PetEntry.COLUMN_PET_GENDER);
       ...
       /* if (breed == null || breed.isEmpty()) {
          //  breed = getString(R.string.unknown_breed);//R.string.unknown_breed;
            breed = getString(R.string.editor_insert_pet_failed);
            //throw new IllegalArgumentException("Pet requires a breed");
        }*/

        if (Integer.toString(weight).isEmpty() || Integer.toString(weight) == null) {
            Log.e(LOG_TAG, "zeft " + uri);
            return null;
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (match) {
            case PETS:
                Log.e(LOG_TAG, "delete all pets");
                rowsDeleted = database.delete(PetEntry.TABLE_NAME, selection, selectionArgs);
                break;


            case PET_ID:
                Log.e(LOG_TAG, "delete specific pet");
                selection = PetEntry._ID + "=?";
                selectionArgs = new String[]{String.valueOf(ContentUris.parseId(uri))};
                rowsDeleted = database.delete(PetEntry.TABLE_NAME, selection, selectionArgs);
                break;
